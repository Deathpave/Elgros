...
namespace ElgrosLibTester.ManagerTests
{
    ...
    internal class ProductManagerTests
    {
        ...
        {
            Product testObject = _manager.ConvertToProduct("Test Product", "This is a test", 100, 100, "", 1, 1, 1000);
            return testObject;
        }
        ...
        {
            Product testObject = _manager.ConvertToProduct("Updated Test Product", "This is an update test", 200, 50, "", 1, 1, 1000);
            return testObject;
        }
    }
}
